...
namespace HemodinksAPI.Api.Data.Migrations
{
    ...
    [Migration("20260610203813_AddEvents")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HemodinksAPI.Api.Models.Convenio", b =>
                {
            ...
            modelBuilder.Entity("HemodinksAPI.Api.Models.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HemodinksAPI.Api.Models.Licenca", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HemodinksAPI.Api.Models.Event", b =>
                {
                    b.HasOne("HemodinksAPI.Api.Models.User", "MedicalUser")
            ...
            modelBuilder.Entity("HemodinksAPI.Api.Models.Licenca", b =>
                {
                    b.HasOne("HemodinksAPI.Api.Models.User", "User")
                        .WithOne("Licenca")
                        .HasForeignKey("HemodinksAPI.Api.Models.Licenca", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HemodinksAPI.Api.Models.Paciente", b =>
                {
                    b.HasOne("HemodinksAPI.Api.Models.Convenio", "ConvenioReferencia")
                        .WithMany("Pacientes")
                    ...
                    b.HasOne("HemodinksAPI.Api.Models.User", "MedicoUser")
                        .WithMany()
