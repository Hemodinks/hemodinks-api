    ...
    : IRequestHandler<GetEventMedicalUsersQuery, IReadOnlyList<EventMedicalUserDto>>
{
    ...
    public GetEventMedicalUsersQueryHandler(AppDbContext context)
    {
        _context = context;
    }
      ...
      IRequestHandler<GetEventByIdQuery, EventDto?>
{
    ...
    public GetEventsQueryHandler(AppDbContext context, IEventReminderProcessor reminderProcessor)
    {
        _context = context;
